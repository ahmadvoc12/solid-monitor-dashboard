...
export default function HeaderLinks(props: {
  ...
  loadMessagesFromSolidPod: (filename: string) => void;
}) {
  const { secondary, setApiKey, loadMessagesFromSolidPod } = props;
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(true); // Atur sesuai kondisi awal Anda
  ...
  routes={routes}
  setApiKey={setApiKey}
  loadMessagesFromSolidPod={loadMessagesFromSolidPod}
/>
